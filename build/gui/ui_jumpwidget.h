...
public:
    ...
    void setupUi(QWidget *JumpWidget)
    {
        if (JumpWidget->objectName().isEmpty())
            JumpWidget->setObjectName(QString::fromUtf8("JumpWidget"));
    ...
    {
        JumpWidget->setWindowTitle(QCoreApplication::translate("JumpWidget", "Form", nullptr));
        cancelButton->setText(QString());
        label->setText(QCoreApplication::translate("JumpWidget", "Jump to call:", nullptr));
        jumpButton->setText(QCoreApplication::translate("JumpWidget", "Jump", nullptr));
    } // retranslateUi
