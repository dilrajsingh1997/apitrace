...
void LeakTraceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LeakTraceThread *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (LeakTraceThread::*)(const QList<ApiTraceError> & );
...
QT_INIT_METAOBJECT const QMetaObject LeakTraceThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_LeakTraceThread.data,
    qt_meta_data_LeakTraceThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
