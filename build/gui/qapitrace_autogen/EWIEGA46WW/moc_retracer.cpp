...
void Retracer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Retracer *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (Retracer::*)(const QString & );
        ...
        {
            using _t = void (Retracer::*)(ApiTraceState * );
        ...
        {
            using _t = void (Retracer::*)(trace::Profile * );
        ...
        {
            using _t = void (Retracer::*)(const QList<QImage> & );
        ...
        {
            using _t = void (Retracer::*)(const ImageHash & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Retracer::foundThumbnails)) {
                *result = 4;
                return;
            }
        ...
        {
            using _t = void (Retracer::*)(const QList<ApiTraceError> & );
...
QT_INIT_METAOBJECT const QMetaObject Retracer::staticMetaObject = { {
    ...
    qt_meta_stringdata_Retracer.data,
    qt_meta_data_Retracer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
