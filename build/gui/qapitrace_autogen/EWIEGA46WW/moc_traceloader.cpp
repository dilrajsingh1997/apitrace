...
void TraceLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TraceLoader *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (TraceLoader::*)(const QString & );
        ...
        {
            using _t = void (TraceLoader::*)(const QList<ApiTraceFrame*> & );
        ...
        {
            using _t = void (TraceLoader::*)(ApiTraceFrame * , const QVector<ApiTraceCall*> & , const QVector<ApiTraceCall*> & , quint64 );
        ...
        {
            using _t = void (TraceLoader::*)(const ApiTrace::SearchRequest & , ApiTrace::SearchResult , ApiTraceCall * );
        ...
        {
            using _t = void (TraceLoader::*)(ApiTraceFrame * );
        ...
        {
            using _t = void (TraceLoader::*)(ApiTraceCall * );
...
QT_INIT_METAOBJECT const QMetaObject TraceLoader::staticMetaObject = { {
    ...
    qt_meta_stringdata_TraceLoader.data,
    qt_meta_data_TraceLoader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
